...
public class NetworkModule {
    ...
    @Provides
    @Singleton
    OkHttpClient provideOkHttp(@Named("OAuth") Interceptor authInterceptor) {
    ...
    @Provides
    @Singleton
    Retrofit provideRetrofit(OkHttpClient client, Gson gson, @Named("base.url") String baseUrl) {
